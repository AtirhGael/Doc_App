      ...
      <View style={styles.button1}>
       ...
       <TouchableOpacity style={[styles.bellow, checked === 1 ? { backgroundColor: '#7851a9' } : null]} onPress={() => setChecked(1)}>
            ...
            <View style={{display:'flex',flexDirection:'column', gap:3}}>
                <Text style={[styles.top, checked === 1 ? { color: "white",fontSize:20,fontWeight:'700'  } : null]}> Voice Call </Text>
                <Text style={[styles.btnText, checked === 1 ? { color: "white",fontSize:15,fontWeight:'500' } : null]}> Can make a voice call with doctor </Text>
            </View>
        
       </TouchableOpacity>
        <View style={{height:15}} />
        <TouchableOpacity style={[styles.bellow, checked === 2 ? { backgroundColor: '#7851a9' } : null]} onPress={() => setChecked(2)}>
        
            <View style={styles.round}>
            <FontAwesome name="video-camera" size={35} color='#088be9' />
            </View>
            <View style={{display:'flex',flexDirection:'column', gap:3,}}>
                <Text style={[styles.top, checked === 2 ? { color: "white",fontSize:20,fontWeight:'700' } : null]}> Vedio Call </Text>
                <Text style={[styles.btnText, checked === 2 ? { color: "white",fontSize:15,fontWeight:'500' } : null]}> Can make a vedio call with doctor </Text>
            </View>
